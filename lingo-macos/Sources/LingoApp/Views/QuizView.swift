...
struct QuizView: View {
    ...
    private func choiceBackground(_ choice: String, question: Question) -> some ShapeStyle {
        ...
        return AnyShapeStyle(Theme.adaptiveBgSecondary)
    }
    ...
    private func sentenceBuilder(_ question: Question) -> some View {
        VStack(spacing: 16) {
            ...
            .padding(12)
            .background(Theme.adaptiveBgSecondary, in: RoundedRectangle(cornerRadius: 10))
            ...
            ForEach(Array(words.enumerated()), id: \.offset) { _, word in
                Button {
                    ...
                    Text(word)
                        ...
                        .padding(.horizontal, 14)
                        .padding(.vertical, 8)
                        .background(viewModel.answerWords.contains(word) ? Theme.adaptiveBgTertiary : Theme.adaptiveBgSecondary)
                        .foregroundStyle(viewModel.answerWords.contains(word) ? .secondary : .primary)
                        .clipShape(RoundedRectangle(cornerRadius: 8))
                }
                .buttonStyle(.plain)
                .disabled(viewModel.hasChecked)
