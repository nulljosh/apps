...
final class AppState {
    ...
    var showTickerBar: Bool = UserDefaults.standard.object(forKey: "epiphany_show_ticker") as? Bool ?? true {
        didSet { UserDefaults.standard.set(showTickerBar, forKey: "epiphany_show_ticker") }
    }
