...
import {
  ...
  USER_SUBSCRIPTIONS as DEMO_SUBSCRIPTIONS,
} from '../config/userProfile';

export { DEMO_HOLDINGS, DEMO_ACCOUNTS, DEMO_BUDGET, DEMO_DEBT, TELUS_DETAILS, DEMO_BILLS, DEMO_GOALS, DEMO_INCOME_PHASES, DEMO_SUBSCRIPTIONS };
...
const ARRAY_FIELDS = ['holdings', 'accounts', 'debt', 'goals', 'spending', 'giving', 'incomePhases', 'subscriptions'];
