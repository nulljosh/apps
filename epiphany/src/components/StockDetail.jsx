...
export default function StockDetail({ stock, onClose, dark, t, onNavigate, currentIndex, totalCount }) {
  ...
  // Scroll to top on mount (panel open) and on symbol change so the header is always visible
  ...
  const stats = useMemo(() => [
    { label: 'Bid', value: d.bid != null ? formatCurrency(d.bid) : '--' },
    { label: 'Ask', value: d.ask != null ? formatCurrency(d.ask) : '--' },
