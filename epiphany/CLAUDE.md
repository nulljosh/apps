...
v1.4.0 -- Personal intelligence platform. Palantir for regular people.
...
- **Stocks**: `server/api/stocks-free.js` -- FMP batch (price/volume/exchange), Yahoo v7 supplement (P/E, mkt cap, EPS, beta, yield, bid, ask, exchange when FMP omits them). Cache key `stocks:free:v2:*`. Web + watchOS use this; iOS/macOS use `server/api/stocks.js`. Fields: bid, ask, exchange added 2026-05-27.
