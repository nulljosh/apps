...
SwiftUI iOS app. Interactive foot/hand reflexology maps, acupuncture points by meridian, symptom finder, session tracker.
...
```bash
xcodegen generate
open Acupuncture.xcodeproj
```

## Key Files
- Sources/AcupunctureApp.swift: Entry point, TabView, splash
- Sources/Models/ReflexologyData.swift: 16 foot + 11 hand zones
- Sources/Models/AcupunctureData.swift: 11 meridians, 35+ points
