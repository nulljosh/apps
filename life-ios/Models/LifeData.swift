...
enum LifeData {
    ...
    static let timeline: [TimelineEntry] = [
        ...
        TimelineEntry(year: "2024", text: "~$50,000 ICBC settlement. Bought car and dog. Kicked out ~June 2024.", detail: "Lived in car ~2 months, shoplifted for food. Broke up with Natania. ~Aug 20: dad let back in. Wellness-check arrest: Langley Hospital, forced antipsychotics, solitary overnight, released next morning.", category: .crisis),
    ...
    static let sections: [LifeSection] = [
        ...
        LifeSection(label: "Friendships", paragraphs: [
            ...
            "Alex is the one friend now. He visits more these days and it's all good between us. We had a big disagreement a while back when he argued parents should hit their kids more, that his dad throwing him on the couch at 12 was good discipline. What he described is nothing compared to what I went through at two, and what I went through is nothing compared to my grandpa at 80 still crying about his dad. We got past it.",
            "We talked again about the period I was kicked out and living in the car. I do remember writing mean blog posts about family and friends back then. Alex's read is that I was basically abandoned by everyone. He agrees with that even though I don't want the victim label.",
            ...
            "I hardly use social media now. The internet feels pointless to me. One friend I lost touch with deactivated his Twitter for a while, but he's back on it now.",
            "School wise, I finished calculus on Duolingo, got a tutor, and I'm finishing it off at LEC. Passed biology.",
        ], note: nil),
        ...
        LifeSection(label: "Housing", paragraphs: [
            ...
            "Separately, my dad's garage door business has run ads using a photo of me from when I was around ten, without any agreement or compensation. That is its own issue, tracked as CASE-0002 in the brief (appropriation of personality), not a housing matter.",
        ...
        LifeSection(label: "Mental Health", paragraphs: [
            ...
            "The most significant hospitalization was a wellness-check incident in 2023 or 2024. I was hitting my head and my dad called police for a wellness check instead of an ambulance. The 911 call came after a verbal disagreement, not a crime and not a visible medical emergency. Police questioned me at the door; I answered lucidly for several minutes, talked them through my roughly 20 tattoos, and said I lived there with my dad. The only thing I declined was discussing my mother, brother, and sister. They declared arrest without giving a reason. I tried to retreat; they chased me, I slipped in the kitchen, they arrested me there, kneeling on my back. Taken to Langley Hospital psych ward. Forced antipsychotic medication. Solitary confinement overnight. Released next morning with no aftercare. I have PTSD from this: constant replays, hypervigilance, poor sleep, GI symptoms. This is the civil suit I'm pursuing, tracked as CASE-0001 in the brief (warrantless dwelling entry on a cooperative subject, Feeney and Godoy).",
