    ...
    <div className="part-list">
      ...
      {parts.map((p, i) => (
        ...
        >
          ...
          <span className="col-total" data-label="Total">
            <span className="total-value">${(p.quantity * p.cost).toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
          </span>
      ...
      <div className="part-list-footer glass-card">
        ...
        <span className="footer-total">
          Total value: ${parts.reduce((s, p) => s + p.quantity * p.cost, 0).toLocaleString('en-US', { minimumFractionDigits: 2 })}
        </span>
      </div>
    </div>
  );
