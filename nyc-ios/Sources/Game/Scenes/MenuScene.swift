...
final class MenuScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        title.fontSize = 48
        title.fontColor = UIColor(red: 0.39, green: 0.82, blue: 1.0, alpha: 1)
        ...
        subtitle.fontColor = UIColor(red: 1.0, green: 0.22, blue: 0.37, alpha: 1)
        ...
        newGame.fontSize = 24
        newGame.fontColor = UIColor(red: 1.0, green: 0.84, blue: 0.04, alpha: 1)
        ...
        loadGame.fontColor = UIColor(red: 0.39, green: 0.82, blue: 1.0, alpha: 1)
    ...
    private func showLoadMenu() {
        ...
        header.fontSize = 28
        header.fontColor = UIColor(red: 0.39, green: 0.82, blue: 1.0, alpha: 1)
        ...
        for i in 0..<3 {
            ...
            bg.strokeColor = UIColor(red: 0.39, green: 0.82, blue: 1.0, alpha: 0.3)
            bg.lineWidth = 1
            ...
            if let slot = slotData {
                ...
                label.fontColor = UIColor(red: 1.0, green: 0.84, blue: 0.04, alpha: 1)
            } else {
